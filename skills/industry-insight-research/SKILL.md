...
If upstream supplies `## Inspiration Hints`, use them as hypotheses to verify rather than as approved strategy directions.
...
- When `## Inspiration Hints` is present, prioritize checking which hinted directions have real evidence support, which are weak, and which have execution or reputation risks.
...
- Return `## Inspiration Signal Check` whenever upstream provided inspiration hints or the brief clearly suggests direction selection risk.
