...
| Delivery feasibility | 25% | Can local dealer/team execute this flow with realistic resources and timeline? | 7, 8 |
| Budget feasibility | 25% | Does the card stay inside stage and total budget red lines? | 11 |
| Theme alignment | 20% | Is the idea aligned with Core Theme + stage sub-theme and sourced from insight? | 1, 2, 13 |

Weighted score formula:

`total_score = pull*0.30 + delivery*0.25 + budget*0.25 + theme*0.20`
...
### Candidate Scores
| Card | Pull (30%) | Delivery (25%) | Budget (25%) | Theme (20%) | Weighted Total | Hard-Gate Status |
| --- | --- | --- | --- | --- | --- | --- |
| A |  |  |  |  |  | pass/fail |
| B |  |  |  |  |  | pass/fail |
